...
save_dir_extract_data = f"/Users/joshuaalbiez/Documents/python/tachinidae_analyzer/data/extract_csv"

df_segments.to_csv(os.path.join(save_dir_extract_data, "df_segments.csv"), index=False)
