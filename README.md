# Example streamlit deployment computer vision interface

> NOTE :rotating_light:  
> The focus of this repo is not on the computer vision model itself. This is simply an example repo for a prototype frontend with [streamlit](https://streamlit.io/) to provide an interface to various computer vision models. Because this repository was initially hosted on a kit gitlab server, there are no commits etc.

![Test](img/gui_overview.png)

This is a web-based application designed for classifying and segmenting objects in images.

Quick feature overview:
- Upload and process images.
- Perform image segmentation to identify object parts.
...
This repository is partially inspired by my master thesis at the Karlsruhe Institute of Technology (KIT) at the Institute for Automation and Applied Informatics (IAI). I cannot provide the original data or models used in the thesis, but I have included a few sample images and models to demonstrate the app's functionality.

Masterthesis: Automated Instance Segmentation and Taxonomic Classification Using Vision Foundation Models
Author: Joshua Albiez (uvtoc@student.kit.edu, joshua.albiez3@gmail.com)
...
- [Installation](#installation)
   ...
   - [Installation Steps](#installation-steps)
      ...
      - [2. Download Docker for your OS](#2-download-docker-for-your-os)
      - [3. Setup required tools](#3-setup-required-tools)
- [Getting started](#getting-started)
   - [Usage](#usage)
   - [Start the app (after succesfull installation)](#start-the-app-after-succesfull-installation)
   - [Overview](#overview)
      - [Side Panel](#side-panel)
      - [Main Panel](#main-panel)
   - [Usage](#usage-1)
   - [Install updates](#install-updates)
- [Getting Started (with programming knowledge)](#getting-started-with-programming-knowledge)
   - [Contributing or Developing](#contributing-or-developing)
   - [Run without script installation without package installation](#run-without-script-installation-without-package-installation)
   - [Examples](#examples)
...
```bash
git clone https://github.com/JoshAlb21/repo_name.git
```
OR
...
### Main Panel
1. **Application Introduction**: Displays the app's purpose - classifying and segmenting objects using state-of-the-art models.
...
1. Upload object images via the sidebar.
...
python -m repo_name.perform_inference.inference_yolov8seg
...
2. run ex_yolov8seg_segments_analyzer -> df_segments_dataset.csv (df_segments.csv + ID_export... .csv)
