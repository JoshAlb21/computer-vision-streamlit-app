...
def main(img_path, save_path, match_path):
    ...
    for i in range(len(all_files)-1):
        source_img_path = os.path.join(img_path, all_files[i])
        target_img_path = os.path.join(img_path, all_files[i+1])
...
if __name__ == '__main__':
    ...
    '''
    img_path = '/Users/joshuaalbiez/Documents/python/computer_vision_streamlit_app/data/stack_imgs/HiDrive-CAS001_CAS0000001_RAW_Data_01/png'
    save_path = '/Users/joshuaalbiez/Documents/python/computer_vision_streamlit_app/data/focus_stacking/align'
    match_save_path = '/Users/joshuaalbiez/Documents/python/computer_vision_streamlit_app/data/focus_stacking/matches'
