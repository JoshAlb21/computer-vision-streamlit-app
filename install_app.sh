...
build_docker_image() {
    ...
    # Replace 'tachinidae_analyzer_image' with your preferred Docker image name
...
run_docker_container() {
    ...
    # Replace 'tachinidae_analyzer_image' with your Docker image name used in the build step
